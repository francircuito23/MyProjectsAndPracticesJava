    ...
    public static void main(String[] args) {
        ...
        do{
            try {
                ...
                System.out.println("No has introducido una nota");
                entrada.nextLine();
            }
        ...
        // Borrar
        //mejor pon el iterador justo arriba, pq creo que daba fallo si lo pones arriba del todo
        //puede ser que me este marcando un triple, pero quiero recordar algo de eso
        Iterator<String> it = clase.keySet().iterator();

        //Crea la variable fuera del bucle, pq sino se va a estar creando todo el rato
        String nombreAlum;
